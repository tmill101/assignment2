...
class CountiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create county" do
    assert_difference("County.count") do
      post counties_url, params: { county: { coordinates: @county.coordinates, name: @county.name, population: @county.population } }
    end
  ...
  test "should update county" do
    patch county_url(@county), params: { county: { coordinates: @county.coordinates, name: @county.name, population: @county.population } }
